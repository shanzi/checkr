...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Email.sent_at_parsed'
        db.add_column(u'submission_email', 'sent_at_parsed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Email.sent_at_parsed'
        db.delete_column(u'submission_email', 'sent_at_parsed')
